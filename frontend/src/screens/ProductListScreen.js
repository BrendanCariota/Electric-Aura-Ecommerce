...
const ProductListScreen = ({ history, match }) => {
    ...
    }, [dispatch, history, userInfo, successDelete, successCreate, createdProduct]) // Pass successDelete that way when it triggers it will run the effect thus getting the updated listProducts again
